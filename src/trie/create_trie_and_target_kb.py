...
all_country_names = pickle_load_large_file('../benchmarks/gwn_withPrompt_country/all_country_names.pkl')
...
with open('../benchmarks/gwn_withPrompt_country/trie.pkl', 'wb') as w_f:
    pickle.dump(trie, w_f)
print("finish running!")
