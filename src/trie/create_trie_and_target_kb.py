...
all_country_names = pickle_load_large_file('../benchmarks/tr-news_withPrompt_state/all_state_names.pkl')
...
with open('../benchmarks/tr-news_withPrompt_state/trie.pkl', 'wb') as w_f:
    pickle.dump(trie, w_f)
print("finish running!")
