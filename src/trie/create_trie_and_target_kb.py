...
all_country_names = pickle_load_large_file('../benchmarks/tr-news_withPrompt_feature/all_feature_class_names.pkl')
...
with open('../benchmarks/tr-news_withPrompt_feature/trie.pkl', 'wb') as w_f:
    pickle.dump(trie, w_f)
print("finish running!")
