...
all_country_names = pickle_load_large_file('../benchmarks/lgl_withPrompt_feature_temp/all_feature_class_names.pkl')
...
with open('../benchmarks/lgl_withPrompt_feature_temp/trie.pkl', 'wb') as w_f:
    pickle.dump(trie, w_f)
print("finish running!")
